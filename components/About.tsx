      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto bg-background p-8 md:p-10 rounded-xl shadow-2xl animate-fade-in-up" style={{animationDelay: '0.2s'}}>
          <img 
            ...
            className="w-32 h-32 rounded-full mx-auto mb-6 border-4 border-secondary shadow-lg hover:scale-105 transition-transform duration-300"
          />
          <p className="text-lg text-gray-300 leading-relaxed mb-4 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-4 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
          ...
          <p className="text-lg text-gray-300 leading-relaxed animate-fade-in-up" style={{animationDelay: '0.5s'}}>
